...
//mod units
  ...
  new G.Unit({
	...
	new G.Tech({
		...
		icon:[26,5],
		cost:{'insight':30},
		req:{'fire-making':true,'building':true,'settle':true},
		effects:[
		],
	});
  ...
  new G.Tech({
		name:'settle',
		desc:'@allows you to settle in one place, stopping migration.<>',
		icon:[24,8],
		cost:{'insight':50,'culture':30},
		req:{'sedentism':true},
		effects:[
		],
	});
    new G.Tech({
		name:'enclosure-ditches',
		desc:'@enclose your settlement in a ditch.<>',
		icon:[24,8],
		cost:{'insight':25},
		req:{'settle':true},
		effects:[
	...
	new G.Policy({
		...
		cost:{'faith':1},
		startMode:'off',
		req:{'ritualism':true,'settle':true},
		category:'faith',
	});
	new G.Policy({
